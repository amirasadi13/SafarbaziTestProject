...
"""
SESSION_COOKIE_AGE = os.getenv('SESSION_COOKIE_AGE', default=1209600)  # Default - 2 weeks in seconds
...
SESSION_COOKIE_SAMESITE = os.getenv('SESSION_COOKIE_SAMESITE', default='Lax')
SESSION_COOKIE_SECURE = os.getenv('SESSION_COOKIE_SECURE', default=False)

CSRF_USE_SESSIONS = os.getenv('CSRF_USE_SESSIONS', default=True)
